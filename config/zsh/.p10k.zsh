# Generated by Powerlevel10k configuration wizard on 2026-04-16 at 15:49 -03.
...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND='#414242'
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#1D70F9'
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#1D70F9'
  ...
  # ─────────────────────────────────────────────
# Custom directory shortening
# ─────────────────────────────────────────────

function my_short_pwd() {
  local path="$PWD"
  local home="$HOME"
  local -a parts

  # Dentro do HOME: substitui /home/user por ~
  if [[ "$path" == "$home" || "$path" == "$home/"* ]]; then
    path="~${path#$home}"
  fi

  # Divide o caminho em diretórios.
  parts=("${(@s:/:)path}")

  # Remove elementos vazios.
  parts=("${(@)parts:#}")

  # Mais de 5 diretórios: mostra .../ + últimos 5.
  if (( ${#parts} > 5 )); then
    print -r -- ".../${(j:/:)parts[-5,-1]}"
  else
    print -r -- "$path"
...
typeset -g POWERLEVEL9K_DIR_CONTENT_EXPANSION='$(my_short_pwd)'
